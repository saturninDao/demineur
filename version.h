...
namespace AutoVersion{
	...
	static const long REVISION  = 1287;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 624;
	#define RC_FILEVERSION 1,2,237,1287
	#define RC_FILEVERSION_STRING "1, 2, 237, 1287\0"
	static const char FULLVERSION_STRING [] = "1.2.237.1287";
